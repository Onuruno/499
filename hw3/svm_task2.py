...
train_labels = np.load('svm/task2/train_labels.npy')
'''
plt.scatter(train_set[train_labels == 0, 0], train_set[train_labels == 0, 1])
plt.scatter(train_set[train_labels == 1, 0], train_set[train_labels == 1, 1])
plt.show()
'''
